...
export default function OzelTurTasimaPage() {
  ...
  const highlights = [
    { title: "Tüm Türkiye", desc: "81 ilde tur hizmeti", icon: Map },
    { title: "10+ Yıl Tecrübe", desc: "Xrem Turizm güvencesi", icon: CheckCircle2 },
    { title: "Kültür & Doğa", desc: "Özel rota planlama", icon: Compass },
    { title: "Grup Gezileri", desc: "Öğrenci ve spor grupları", icon: Users },
    { title: "Aktivite Turları", desc: "Tekne ve av turları", icon: Camera },
  ];
      ...
      <section className="relative pt-44 pb-16 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <span className="text-[10px] font-black text-gold tracking-[0.5em] uppercase mb-4 block italic">Discovery & Adventure</span>
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1a1a1a] italic leading-tight mb-6">
              ÖZEL TUR <br /> <span className="text-gold">TAŞIMACILIĞI</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            >
              <div className="bg-white/40 backdrop-blur-md border border-white p-8 md:p-14 rounded-[3.5rem] shadow-xl">
                <h2 className="text-2xl font-black italic uppercase text-[#1a1a1a] mb-8 tracking-tighter">ÖZEL TUR TAŞIMA</h2>
                ...
                <div className="space-y-6 text-[#1a1a1a] font-bold text-sm md:text-base leading-relaxed opacity-80 text-justify">
                  ...
                  <p>
                    Hizmet yelpazemiz; Öğrenci turları (Kapadokya, Ilgaz, Bursa Uludağ, Bolu Abant, Gölcük vb.), Spor turnuva grupları, Eğlence gezileri, Tekne turları, Balık avlama turları ve Doğa Turları gibi geniş bir alanı kapsamaktadır. Turlarda şirket olarak güvenli taşıma hizmeti tescillenmiş firma adımızla Xrem Turizm olarak 10 yılı aşkın tecrübemizle en profesyonel lojistik desteği sağlıyoruz.
                  </p>
                  <p>
              ...
              <div className="bg-white/80 backdrop-blur-xl border border-white p-8 md:p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                  ...
                  <div className="relative group/field bg-cream border border-cream rounded-2xl transition-all focus-within:border-gold shadow-inner" ref={passengerRef}>
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <span className="text-[10px] font-black text-[#1a1a1a] uppercase tracking-wider block">KiŞİ SEÇİMİ</span>
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    placeholder="Tur Rotası, Beklenen Duraklar ve Özel İstekleriniz..." 
    ...
    <div className="flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4 bg-cream p-1.5 rounded-full border border-cream-dark shadow-inner">
        ...
        <button 
          ...
          className="w-8 h-8 bg-white/80 rounded-full flex items-center justify-center text-gray-500 hover:bg-white hover:text-gold transition-all border border-cream shadow-sm"
        >
