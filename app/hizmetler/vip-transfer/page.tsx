...
import { Clock, CheckCircle2, Send, CalendarDays, Users, Timer, ChevronRight, Plus, Minus, Briefcase, Star, Map, Plane, Wifi, Coffee } from "lucide-react";
...
export default function VipTransferPage() {
  ...
  const highlights = [
    { title: "Geniş Filo", desc: "Vito & Sprinter seçenekleri", icon: Plane },
    { title: "VIP Konfor", desc: "TV, WiFi ve Buzdolabı", icon: Wifi },
    { title: "7/24 Destek", desc: "WhatsApp & Viber hattı", icon: Clock },
    { title: "Çocuk Dostu", desc: "Ücretsiz bebek koltuğu", icon: Star },
    { title: "Özel İkram", desc: "Soğuk su ve atıştırmalık", icon: Coffee },
  ];
      ...
      <section className="relative pt-44 pb-16 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <span className="text-[10px] font-black text-gold tracking-[0.5em] uppercase mb-4 block italic">Professional Transport</span>
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1a1a1a] italic leading-tight mb-6">
              ANTALYA HAVALİMANI <br /> <span className="text-gold">VIP TRANSFER</span>
            </h1>
            ...
            >
              <div className="bg-white/40 backdrop-blur-md border border-white p-8 md:p-14 rounded-[3.5rem] shadow-xl">
                ...
                <div className="space-y-6 text-[#1a1a1a] font-bold text-sm md:text-base leading-relaxed opacity-80 text-justify">
                  <p>
                    Antalya havalimanı transfer firması olarak yerli ve yabancı birçok misafire hizmet vermekteyiz. Kişi sayısına göre tercih edilen araçlar ile tüm misafirlerimize konforlu, kaliteli ve Antalya havalimanı uygun fiyat ulaşım hizmeti sunmaktayız. Ulaşabileceğimiz tüm kesimlere hitap etmek için Antalya belek transfer, Antalya otel transfer, Antalya Side transfer her zaman uygun fiyat ve kaliteli hizmet sunmaktayız. İster yalnız, ister küçük aile veya kalabalık arkadaş grubu kaç kişi olursanız olun her zaman uygun kapasiteli araçlarımız ile hizmetinizdeyiz. 1-6 kişilik Mercedes VIP Vito araçlarımız ile gitmek istediğiniz yere kadar hizmet vermekteyiz. 1-13 kişilik Mercedes VIP Sprinter ile kalabalık gruplarınız ile tercih edebilirsiniz. Antalya Vip Transfer hizmeti tercihinizde, deri koltuklu talebinize göre televizyonlu, wifi bulunan araçlarımız sizler için hizmet vermektedir.
                  </p>
                  <p>
                    Antalya Havalimanı Transfer bölgesine hizmet verdiğimiz için sıcak havalarda siz değerli misafirlerimize sorun yaratmamak için tüm araçların rutin klima, motor ve dizayn bakımları yapılmaktadır. Her zaman araç içlerinde bulunan buzdolabı ile su hizmetimiz mutlaka bulunmaktadır. Antalya Havalimanı transfer firması olarak sizleri havalimanında karşılıyor bekletmeden gitmek istediğiniz adrese kadar Antalya belek transfer olarak vip transfer hizmeti sunuyoruz. Her zaman iletişim numarası üzerinden whatsaap, viber, mail veya web sitesi üzerinde sohbet olarak yardımcı olabiliriz. Olumlu ve olumsuz bütün bildirimlerinize her zaman geri dönüş yapılacaktır. 7/24 hizmet sunan Antalya Vip Transfer firması Fig Travel, sizleri hangi saatte isterseniz o saatte kapınızdan alır ve gitmek istediğiniz noktaya kolay ve güvenli bir şekilde ulaşmanızı sağlar. Yolculuk boyunca 3. Şahıslar veya yabancı müşteriler sizi rahatsız etmez, araçlarımızda yalnızca siz ve sevdikleriniz bulunur.
                  </p>
                  <p>
                    Tatil, iş seyahati veya bir toplantı için uçak ile seyahat etmeniz gerektiği zaman her zaman sizlere Antalya havalimanında bekliyor olacağız, Antalya havalimanında sizleri karşılayıp gitmek istediğiniz konuma, adrese kadar Antalya vip transfer hizmeti sunmaktayız. Bebek koltuğu talebiniz doğrultusunda bebek koltuğu aracınıza eklenir küçük misafirlerimizde konforlu bir şekilde yolculuklarını tamamlarlar. Araç içi küçük ikramlar ile minikler için keyifli bir hal alacaktır yolculuğunuz. Tatiliniz araçtayken başlasın.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-xl border border-white p-8 md:p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    placeholder="Alış-Varış Noktası ve Özel Talepleriniz..." 
