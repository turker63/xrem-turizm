...
export default function KongreFuarTasimaciligiPage() {
  ...
  const highlights = [
    { title: "Kurumsal Filo", desc: "S, E ve V-Class araçlar", icon: Building2 },
    { title: "Büyük Gruplar", desc: "500 - 10.000 kişi kapasite", icon: Users },
    { title: "Tam Koordinasyon", desc: "Uçuş ve otel planlama", icon: Map },
    { title: "Deneyimli Ekip", desc: "Profesyonel saha personeli", icon: CheckCircle2 },
    { title: "Global Standart", desc: "Uluslararası fuar desteği", icon: Briefcase },
  ];
      ...
      <section className="relative pt-44 pb-16 overflow-hidden z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <span className="text-[10px] font-black text-gold tracking-[0.5em] uppercase mb-4 block italic">Corporate Logistics</span>
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-[#1a1a1a] italic leading-tight mb-6">
              KONGRE VE FUAR <br /> <span className="text-gold">TAŞIMACILIĞI</span>
            </h1>
              ...
              <div className="bg-white/80 backdrop-blur-xl border border-white p-8 md:p-10 rounded-[3rem] shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                  ...
                  <div className="relative group/field bg-cream border border-cream rounded-2xl transition-all focus-within:border-gold shadow-inner" ref={passengerRef}>
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <span className="text-[10px] font-black text-[#1a1a1a] uppercase tracking-wider block">GRUP SAYISI</span>
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    placeholder="Organizasyon Adı, Güzergah ve Araç Tercihleri..." 
