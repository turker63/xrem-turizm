...
export default function SSSPage() {
  const corporateLinks = [
    ...
    { name: "Yolcu Taşıma", href: "/yolcu-tasima" },
    { name: "Güvenlik ve Gizlilik Sözleşmesi", href: "/gizlilik" },
    { name: "İptal ve İade Koşulları", href: "/iptal-iade" },
    { name: "Kişisel Verilerin Korunması Kanunu", href: "/kvkk" },
  ];
    ...
    <main className="min-h-screen bg-cream flex flex-col relative overflow-x-hidden">
      ...
      <section className="pt-44 pb-16 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="text-[10px] font-black text-gold tracking-[0.5em] uppercase mb-4 block">Destek Merkezi</span>
            <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter text-[#1a1a1a] italic leading-none mb-6">
              SIKÇA SORULAN <br /> <span className="text-gold">SORULAR</span>
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-8">
            <div className="bg-white/40 backdrop-blur-md rounded-[3rem] p-8 md:p-12 border border-white shadow-xl">
              <div className="flex items-center gap-4 mb-12">
                ...
                <div>
                  <h2 className="text-xl font-black uppercase tracking-tight text-[#1a1a1a]">Merak Edilenler</h2>
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Hizmetlerimiz hakkında detaylı bilgiler</p>
                </div>
              </div>
              <FAQ />
            </div>
          ...
          >
            {/* KURUMSAL BELGELER KUTUSU (STANDART CAM EFEKTİ) */}
            ...
            {/* İLETİŞİM & WHATSAPP KUTUSU */}
            <div className="bg-gold p-10 rounded-[3rem] shadow-2xl text-white relative overflow-hidden group">
              <div className="relative z-10">
                <span className="bg-white/20 px-4 py-1 rounded-full text-[9px] font-black uppercase tracking-widest mb-4 inline-block">7/24 Canlı Destek</span>
                <h4 className="text-2xl font-black mb-4 leading-tight italic uppercase tracking-tighter">Cevabınızı bulamadınız mı?</h4>
                <p className="text-[11px] font-bold opacity-90 mb-8 uppercase tracking-widest">Size bir WhatsApp uzağındayız.</p>
                <a 
                ...
                >
                  <MessageCircle size={18} /> WhatsApp Hattı
                </a>
              </div>
